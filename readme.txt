...
== Changelog ==
 ...
 = 1.0.7 - Add custom API endpoint

 = 1.0.6 - Add caching options

 = 1.0.4 - Updated for new API changes

 = 1.0.3 - Tested up to 4.3 =

 = 1.0.2 - Maintenance =

 1. Fixed offset
 2. Add limit & sort_option to search form
 3. Fix single quote in search
